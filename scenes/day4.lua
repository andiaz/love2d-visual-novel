return {
    ...
    dialogue = {
        ...
        { speaker = "ux", expression = "thinking", text = "(Riley's right. I should have flagged that earlier.)" },
        ...
        { speaker = "dev", expression = "frustrated", text = "A list. More features. Great.", condition = "prioritized_product" },
