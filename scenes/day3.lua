return {
    ...
    dialogue = {
        ...
        { speaker = "ux", expression = "frustrated", text = "(We haven't even agreed on phase 1.)", condition = "needs_requirements" },
        ...
        -- End of day
        { speaker = "ux", expression = "frustrated", text = "Day 3. We have no requirements, a demo deadline, and a 47-slide mood board." },
