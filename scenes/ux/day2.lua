return {
    ...
    dialogue = {
        { speaker = "pm", expression = "cheerful", text = "Good morning! Welcome to standup. Let's keep it tight -- what did you do yesterday, what are you doing today, any blockers?" },
        ...
        -- Interview path
        { speaker = "pm", expression = "stressed", text = "Interviews? That'll take at least a week. We don't have that kind of time.", condition = "pushed_interviews" },
        ...
        -- Wireframe path
        { speaker = "po", expression = "excited", text = "Yes! I love it. Start with the social feed -- that's the hero feature.", condition = "started_wireframes" },
        ...
        -- Requirements path
        { speaker = "po", expression = "defensive", text = "The vision IS the requirement! It's all in the deck!", condition = "needs_requirements" },
