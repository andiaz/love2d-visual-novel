return {
    ...
    dialogue = {
        ...
        { speaker = "arch", expression = "concerned", text = "I owe the team an apology. I spent too much time on the 'right' architecture and not enough time on the architecture that ships." },
        ...
        { speaker = "po", expression = "excited", text = "I know I was... a lot. But Chimera is real now. It exists. That's because of all of you." },
        ...
        { speaker = "dev", expression = "smiling", text = "Don't make me cry in a standup, Alex.", condition = "final_grateful" },

        -- End of story
        { speaker = "ux", expression = "thinking", text = "Fifteen days. Six people. One product. Countless arguments." },
