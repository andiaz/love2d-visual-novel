return {
    ...
    dialogue = {
        ...
        { speaker = "ux", expression = "thinking", text = "My interview findings are clear. Users don't want what we're building.", condition = "pushed_interviews" },
        ...
        { speaker = "qa", expression = "smirk", text = "So the research says the 47-slide deck is wrong?", condition = "pushed_interviews" },
        ...
        { speaker = "ux", expression = "thinking", text = "I just realized something. I've been designing for a week and I've never talked to an actual user.", condition = {pushed_interviews = nil} },
        { speaker = "ux", expression = "thinking", text = "Everything I know about our users comes from Priya's deck. Slide 7: 'Users love sharing knowledge!'", condition = {pushed_interviews = nil} },
        { speaker = "ux", expression = "frustrated", text = "(Citation: none.)", condition = {pushed_interviews = nil} },

        -- The confrontation
        { speaker = "po", expression = "excited", text = "Alex! I've been thinking about the content creation flow. Can we add templates? And AI suggestions?" },
        ...
        -- Data path
        { speaker = "po", expression = "defensive", text = "Wrong problem? But the deck... the vision...", condition = "followed_data" },
        ...
        { speaker = "qa", expression = "smirk", text = "That took guts, Alex.", condition = "followed_data" },

        -- Vision path
        { speaker = "po", expression = "excited", text = "Yes! I knew you'd see it! The vision is everything!", condition = "followed_vision" },
        ...
        -- Middle path
        { speaker = "po", expression = "defensive", text = "Narrow the scope? But everything is essential!", condition = "found_middle" },
        ...
        { speaker = "dev", expression = "smiling", text = "Welcome to product development." },
