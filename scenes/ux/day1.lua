return {
    ...
    dialogue = {
        ...
        { speaker = "pm", expression = "cheerful", text = "I'm Jordan, your PM. Let's do a quick round of intros -- just name and role, 30 seconds each." },
        ...
        { speaker = "dev", expression = "frustrated", text = "...forty-seven?" },
        ...
        -- User research path
        { speaker = "po", expression = "defensive", text = "User research? We already know what users want. I talked to my cousin who uses apps.", condition = "wants_research" },
        { speaker = "qa", expression = "deadpan", text = "I mean... actual research wouldn't hurt.", condition = "wants_research" },
        { speaker = "pm", expression = "neutral", text = "Let's table the research discussion. We have a tight timeline.", condition = "wants_research" },

        -- Vision path
        { speaker = "po", expression = "excited", text = "Oh you're going to LOVE this. Picture a platform that's like Uber, but for... internal knowledge sharing.", condition = "eager_for_vision" },
        { speaker = "dev", expression = "neutral", text = "So... a wiki?", condition = "eager_for_vision" },
        { speaker = "po", expression = "excited", text = "No no no. A SMART wiki. With AI. And gamification.", condition = "eager_for_vision" },

        -- Direct question path
        { speaker = "pm", expression = "neutral", text = "Great question! Priya, the elevator pitch?", condition = "asked_what" },
        { speaker = "po", expression = "excited", text = "It's a knowledge-sharing platform. Think Confluence meets TikTok meets LinkedIn.", condition = "asked_what" },
        ...
        { speaker = "pm", expression = "cheerful", text = "Oh, and it'll be quick. 15 minutes tops." },
